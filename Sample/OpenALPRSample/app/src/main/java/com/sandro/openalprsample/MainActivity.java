    ...
    public class JavaScriptInterface {
        ...
        private void checkPermission() {
            ...
            if (!permissions.isEmpty()) {
                Toast.makeText(MainActivity.this, "Storage access needed to manage the picture.", Toast.LENGTH_LONG).show();
                String[] params = permissions.toArray(new String[permissions.size()]);
                ActivityCompat.requestPermissions(MainActivity.this, params, STORAGE);
